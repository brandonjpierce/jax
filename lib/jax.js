...
(function(root, factory) {
  ...
  function Response(req) {
    ...
    this.raw = this.request.xhr.responseText || null;

    var shortStatus = round(this.status / 100);
  ...
  /**
   * Helper method to format data before sending the request
   */
  Request.prototype.formatData = function() {
  ...
  /**
   * Helper method to format url queries before sending the request
   */
  Request.prototype.formatQueries = function() {
  ...
  /**
   * Helper method to format headers before sending the request
   */
  Request.prototype.formatHeaders = function() {
  ...
  Request.prototype.done = function(callback) {
    ...
    // must be before opening to make sure URL is formatted correctly
    this.formatQueries();
   ...
   * @param {string}      method   The HTTP request method
   * @param {string}      url      The HTTP request url
   * @param {Object|null} callback Optional callback for syntax sugar
   */
  function Jax(method, url, callback) {
    if (callback) {
      return new Request(method, url).done(callback);
    }
   ...
   */
  Jax.get = function(url, callback) {
    callback = util.isFunction(callback) ? callback : null;

    return new Jax('GET', url, callback);
  };
   ...
   * @return {Object}               An instance of our Request Object
   */
  Jax.post = function(url, callback) {
    callback = util.isFunction(callback) ? callback : null;

    return new Jax('POST', url, callback);
  };
   ...
   * @return {Object}               An instance of our Request Object
   */
  Jax.put = function(url, callback) {
    callback = util.isFunction(callback) ? callback : null;

    return new Jax('PUT', url, callback);
  };
   ...
   * @return {Object}               An instance of our Request Object
   */
  Jax.del = function(url, callback) {
    callback = util.isFunction(callback) ? callback : null;

    return new Jax('DELETE', url, callback);
  };
